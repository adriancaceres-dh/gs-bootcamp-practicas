...
public class Person {
    // estas dos anotaciones van SIEMPRE!
    @Id
    ...
    //@GeneratedValue(strategy = GenerationType.SEQUENCE) // genera estructuras especiales que se llaman triggers
    // y cuando se agrega un nuevo campo, la secuencia cambia de valor. Oracle
    //@GeneratedValue(strategy = GenerationType.UUID) // genera valores de forma aleatoria.
    private Integer id;
    // definir o  no propiedades de columna
