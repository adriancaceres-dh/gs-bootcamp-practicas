public class Main {
    public class Main {
        public static void main(String[] args) {
            ...
            Juegoasteroide juegoasteroide = new Juegoasteroide(listaParticipantes());
            juegoasteroide.jugar(new Coordenada(4,4));
            System.out.println("Ganador " + juegoasteroide.ganador());
