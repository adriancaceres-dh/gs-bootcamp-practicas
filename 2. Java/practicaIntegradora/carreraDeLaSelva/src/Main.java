...
// LO QUE HABÍA HECHO ANTES DE LA CLASE
        /*
        ...
        int emergencia = scanner.nextInt();
        System.out.println("Ingrese su grupo sanquíneo");
        String sangre = scanner.next();
        System.out.println("Escriba el circuito en el que desea inscribirse: chico, medio, avanzado");
        String circuito = scanner.next();

        //Map<String, List<String>> inscriptos = new TreeMap<>();
