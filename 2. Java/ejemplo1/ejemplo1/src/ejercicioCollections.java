...
public class ejercicioCollections {
    public static void main(String[] args) {
        ...
        circuitos.put("Cricuito 1", "2km");
        circuitos.put("Cricuito 2", "5km");
        circuitos.put("Cricuito 3", "10km");
        ...
        System.out.println("Datos participantes circuito 1: " + datosParticipantesCircuito1);

        System.out.println("Datos participantes circuito 2: " + datosParticipantesCircuito2);

        System.out.println("Datos participantes circuito 3: " + datosParticipantesCircuito3);
