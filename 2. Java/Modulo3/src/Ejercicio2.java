public class Ejercicio2 {
   // String 1nombre; falta el nombre de la variable, el igual y las comillas
   // int edad; falta el igual y el número entero
   // double $ueldo; falta el igual y el número con decimal que es la variable
