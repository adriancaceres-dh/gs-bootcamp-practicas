...
public class ejemploMapa2 {
    public static void main(String[] args) {
        ...
        indice.put("Autores", List.of("Borges"," Charles"));

        for (Map.Entry<String,List<String>> capitulos: indice.entrySet()) {
            System.out.println(capitulos.getKey() + capitulos.getValue());
        }
    }
}
