...
public class ObtenerDiplomaService implements IObtenerDiplomaService {
    ...
    private String getGreetingMessage(String studentName, Double average) {
        return "El alumno " + studentName + " ha obtenido un promedio de " + ((average == null) ? "null" : new DecimalFormat("0.00", DecimalFormatSymbols.getInstance(Locale.US)).format(average))
