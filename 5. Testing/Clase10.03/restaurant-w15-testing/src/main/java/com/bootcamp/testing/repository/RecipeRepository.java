...
//Los metodos constructores no se testean porque se testean automaticamente
    public RecipeRepository () {
        loadDataBase();
    }
//en la creacion de un objeto repositorio
    ...
    public Optional<Recipe> getRecipe ( String name ) {
        ...
        recipe.orElseThrow(() -> {throw new RecipeNotFoundException("No se pudo encontrar la receta " + name);});
