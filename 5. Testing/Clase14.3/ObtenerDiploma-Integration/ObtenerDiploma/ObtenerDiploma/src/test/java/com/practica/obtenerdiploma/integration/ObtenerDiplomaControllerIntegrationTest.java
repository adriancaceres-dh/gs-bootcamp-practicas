...
public class ObtenerDiplomaControllerIntegrationTest {
    ...
    public void analyzeScores () throws Exception {
        // arrange
        Long studentId = 1L;
        StudentDTO expected = TestUtilsGenerator.getStudentWithId(studentId);
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get("/student/analyzeScores/" + studentId)
