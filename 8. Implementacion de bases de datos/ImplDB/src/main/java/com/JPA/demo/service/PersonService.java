...
public class PersonService implements IPersonService {
    ...
    @Autowired //llamamos el repositorio
    ...
    public PersonDTO saveEntity(PersonDTO personDTO) {
        //guardamos en los repos entidades, por eso convertimos el personDTO a entidad
    ...
    public List<PersonDTO> getAllEntities() {
        ...
        return list.stream().map(
                person -> mapper.map(person, PersonDTO.class) //cada person que haya lo convertimos a PersonDTO
        )
