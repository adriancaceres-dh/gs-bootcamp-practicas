...
public class StudentController {
    ...
    public ResponseEntity<List<StudentDTO>> findByAges(@RequestParam(required = false) Short desde, @RequestParam(required = false) Short hasta ){
        return ResponseEntity.ok(studentService.findByAges(desde, hasta));
    }*/
}
