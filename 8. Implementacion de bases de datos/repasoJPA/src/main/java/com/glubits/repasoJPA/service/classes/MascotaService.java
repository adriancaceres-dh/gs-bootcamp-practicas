...
public class MascotaService implements ICrudService<MascotaDTO, Integer> {
    ...
    public List<MascotaDTO> findByTipoYVeterinario(String tipo, Integer id){
        var list = mascotaRepository.findMascotaByTipoAnimalEqualsAndVeterinarioIdEquals(tipo, id);
    ...
    public List<Map<String, Number>> findByVeterinarioPerTipo(String tipo){
        return mascotaRepository.calculateTipoAnimalPerVeterinario(tipo);
    }
}
